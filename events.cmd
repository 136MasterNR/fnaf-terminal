...
IF %freddy[level]% GEQ 4 IF NOT !MO_FREDDY! GTR 18 IF !TIMER! EQU 240 SET /A MO_FREDDY+=1&ECHO.DIFFICULTY: !MO_FREDDY! FREDDY&:: 4 minutes in
IF %freddy[level]% GEQ 2 IF NOT !MO_CHICA! GTR 18 IF !TIMER! EQU 300 SET /A MO_CHICA+=1&ECHO.DIFFICULTY: !MO_CHICA! CHICA&:: 5 minutes in
IF %freddy[level]% GEQ 3 IF NOT !MO_FOXY! GTR 18 IF !TIMER! EQU 300 SET /A MO_FOXY+=1&ECHO.DIFFICULTY: !MO_FOXY! FOXY&:: 5 minutes in
IF %freddy[level]% GEQ 4 IF NOT !MO_FOXY! GTR 18 IF !TIMER! EQU 330 SET /A MO_FOXY+=1&ECHO.DIFFICULTY: !MO_FOXY! FOXY&:: 5.5 minutes in
...
IF %freddy[level]% GEQ 3 IF NOT !MO_BONNIE! GTR 18 IF !TIMER! EQU 450 SET /A MO_BONNIE+=1&ECHO.DIFFICULTY: !MO_BONNIE! BONNIE &:: 7.5 minutes in
IF %freddy[level]% GEQ 4 IF NOT !MO_FREDDY! GTR 18 IF !TIMER! EQU 480 SET /A MO_FREDDY+=1&ECHO.DIFFICULTY: !MO_FREDDY! FREDDY &:: 8 minutes in
