...
IF %VIEW%==OFFICE ( ECHO.[47;5H%RGB%93;68;72mP%RGB%2;2;2mower:%RGB%0;0;0m %BATTERY%%% ) ELSE ECHO.[47;5H%RGB%19;19;23mP%RGB%4;4;8mow%RGB%19;19;23me%RGB%4;4;8mr: %BATTERY%%%%RGB%19;19;23m 
