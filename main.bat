	...
	IF %VIEW%==OFFICE ( ECHO.[47;5H%RGB%93;68;72mP%RGB%2;2;2mower:%RGB%0;0;0m %BATTERY%%% ) ELSE (
		IF %CAMS_STATE%==_1 (
			IF %CAMS_STATES%==_1_freddy_bonnie_chica (
				ECHO.[49;67H%RGB%93;96;124m[1mPress SP%RGB%4;4;4mACE %RGB%128;134;151mt%RGB%27;27;27mo c%RGB%3;3;10mlose the cams[0m
			...
			ECHO.[49;67H%RGB%9;9;11m[1mPre%RGB%32;28;44mss%RGB%9;9;11m[1m SPACE %RGB%32;28;44mto %RGB%60;61;72mcl%RGB%9;9;11mose%RGB%32;28;44m the %RGB%9;9;11mcams[0m
		) ELSE (
